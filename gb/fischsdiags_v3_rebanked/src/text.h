...
BANKREF_EXTERN(text_print_string_bkg)
extern void text_load_font() BANKED;
BANKREF_EXTERN(text_print_string_bkg)
extern void text_print_string_bkg(UINT8 x, UINT8 y, unsigned char *string) BANKED;
BANKREF_EXTERN(text_print_char_bkg)
extern void text_print_char_bkg(UINT8 x, UINT8 y, unsigned char chr) BANKED;
